...
from test_framework.scripts.applescripts import LOG_OUT_USER_APPLESCRIPT
...
class LoginManager:
    ...
    Architecture:
    - ServiceManager: For verification & AppleScript logout operations
    - Tapper: Independent physical hardware control (no gRPC dependency)
    ...
    Usage:
        ...
        login_mgr = LoginManager(services, station_id="station1")
    ...
    def __init__(self, 
        ...
        Args:
            service_manager: ServiceManager for verification & AppleScript operations
        ...
        """
        # ServiceManager for verification & AppleScript (gRPC operations)
        ...
        # Initialize tapper independently (no ServiceManager dependency)
    ...
    def health_check(self) -> bool:
        ...
        """
        try:
            # Test ServiceManager connectivity
            if not self.services.health_check("root"):
                self.logger.error("❌ ServiceManager health check failed")
                return False
    ...
    def _perform_applescript_logout(self, username: str) -> bool:
        ...
        try:
            apple_script_service = self.services.apple_script("user")
...
def create_login_manager(service_manager: ServiceManager, 
                        station_id: Optional[str] = None,
    ...
    Args:
        service_manager: ServiceManager instance for gRPC operations
